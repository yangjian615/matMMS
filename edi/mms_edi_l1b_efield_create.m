...
%
% Calling Sequence
%   EDI = mms_edi_l1b_efield_create(FILENAME, TSTART, TEND)
...
%
%   [GD12_GSE, GD21_GSE] = mms_edi_l1b_efield_create(__, 'ParamName', ParamValue)
...
%   2015-08-23      Renamed from mms_edi_create_l1b to mms_edi_l1b_efield_create. - MRA
%
function edi = mms_edi_l1b_efield_create(filenames, tstart, tend, varargin)
