...
%------------------------------------%
	...
	% Beam convergence
	assert( isa(efield_bc.tt2000_bc,     'int64'),  'efield_bc.tt2000_bc should be int64.' );
	assert( isa(efield_bc.E_bc_dmpa,     'single'), 'efield_bc.E_bc_dmpa should be single.');
	assert( isa(efield_bc.v_bc_dmpa,     'single'), 'efield_bc.v_bc_dmpa should be single.');
	assert( isa(efield_bc.d_bc_dmpa,     'single'), 'efield_bc.d_bc_dmpa should be single.');
	assert( isa(efield_bc.d_std_bc_dmpa, 'single'), 'efield_bc.d_std_bc_dmpa should be single.');
	assert( isa(efield_bc.quality_bc,    'uint8'),  'efield_bc.quality_bc should be uint8.');
	
	% Cost function
	assert( isa(efield_cf.tt2000_cf,  'int64'),  'efield_cf.tt2000 should be int64.' );
	assert( isa(efield_cf.E_cf_dmpa,  'single'), 'efield_cf.E_cf_dmpa should be single.');
	assert( isa(efield_cf.v_cf_dmpa,  'single'), 'efield_cf.v_cf_dmpa should be single.');
	assert( isa(efield_cf.d_cf_dmpa,  'single'), 'efield_cf.d_cf_dmpa should be single.');
	assert( isa(efield_cf.d_delta_cf, 'single'), 'efield_cf.d_delta_cf should be single.');
...
%------------------------------------------------------
	...
	% Variable Data
	var_list = { tt2000_vname,       efield_cf.tt2000_cf',     ...
	             dtt2000_vname,      b_interp.dt_avg,          ...
	             e_cf_vname,         efield_cf.E_cf_dmpa',     ...
	             v_cf_vname,         efield_cf.v_cf_dmpa',     ...
	             d_cf_vname,         efield_cf.d_cf_dmpa',     ...
	             e_bc_vname,         efield_bc.E_bc_dmpa',     ...
	             v_bc_vname,         efield_bc.v_bc_dmpa',     ...
	             d_bc_vname,         efield_bc.d_bc_dmpa',     ...
	             d_std_bc_vname,     efield_bc.d_std_bc_dmpa', ...
	             q_bc_vname,         efield_bc.quality_bc',    ...
