...
%     and created by mmms_sdc_edi_ql_efield.m to a CDF file named
%     EDI_QL_FILE.
%
% Parameters
...
%
function edi_ql_file = mms_sdc_edi_write_ql_efield(edi_ql)
%------------------------------------%
% Create CDF File                    %
%------------------------------------%
	...
	mods    = {  'v0.0.0 -- First version.', ...
	            ...
	            ['v0.1.2 -- Added "recnum" variables. Fixed probem with Gun2 beams.'], ...
	          };
