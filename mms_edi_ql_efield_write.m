...
%   2015-08-23      Renamed from mms_edi_write_ql_efield to mms_edi_ql_efield_write. - MRA
%
function edi_ql_file = mms_edi_ql_efield_write(edi_ql)
%------------------------------------%
% Create CDF File                    %
%------------------------------------%
	...
	% Check sizes
	assert( isa(edi_ql.tt2000,        'int64'),  'edi_ql.tt2000 should be int64.' );
	assert( isa(edi_ql.dt,            'int64'),  'edi_ql.dt should be int64.' );
	assert( isa(edi_ql.tt2000_gd12,   'int64'),  'edi_ql.tt2000_gd12 should be int64.');
	assert( isa(edi_ql.tt2000_gd21,   'int64'),  'edi_ql.tt2000_gd21 should be int64.');
	assert( isa(edi_ql.E_dmpa,        'single'), 'edi_ql.E_dmpa should be single.');
	assert( isa(edi_ql.v_dmpa,        'single'), 'edi_ql.v_dmpa should be single.');
	assert( isa(edi_ql.d_dmpa,        'single'), 'edi_ql.d_dmpa should be single.');
	assert( isa(edi_ql.B_dmpa,        'single'), 'edi_ql.B_dmpa should be single.');
	assert( isa(edi_ql.d_std_dmpa,    'single'), 'edi_ql.d_dmpa should be single.');
	assert( isa(edi_ql.B_std_dmpa,    'single'), 'edi_ql.B_dmpa should be single.');
	assert( isa(edi_ql.quality,       'uint8'),  'edi_ql.quality should be uint8.');
	assert( isa(edi_ql.quality_gd12,  'uint8'),  'edi_ql.quality_gd12 should be uint8.');
	assert( isa(edi_ql.quality_gd21,  'uint8'),  'edi_ql.quality_gd21 should be uint8.');
	assert( isa(edi_ql.fv_gd12_dmpa,  'single'), 'edi_ql.fv_gd12_dmpa should be single.');
	assert( isa(edi_ql.fv_gd21_dmpa,  'single'), 'edi_ql.fv_gd21_dmpa should be single.');
	assert( isa(edi_ql.pos_vg1_dmpa,  'single'), 'edi_ql.pos_vg1_dmpa should be single.');
	assert( isa(edi_ql.pos_vg2_dmpa,  'single'), 'edi_ql.pos_vg2_dmpa should be single.');
	assert( isa(edi_ql.recnum,        'uint32'), 'edi_ql.recnum should be uint32.');
	assert( isa(edi_ql.recnum_gd12,   'uint32'), 'edi_ql.recnum_gd12 should be uint32.');
	assert( isa(edi_ql.recnum_gd21,   'uint32'), 'edi_ql.recnum_gd21 should be uint32.');
...
%------------------------------------------------------
	...
	var_list = { tt2000_vname,       edi_ql.tt2000, ...
	             ...
	             e_vname,            edi_ql.E_dmpa, ...
	             v_vname,            edi_ql.v_dmpa, ...
	             d_vname,            edi_ql.d_dmpa, ...
	             d_std_vname,        edi_ql.d_std_dmpa, ...
	             b_vname,            edi_ql.B_dmpa, ...
	             b_std_vname,        edi_ql.B_std_dmpa, ...
	             quality_vname,      edi_ql.quality, ...
	             pos_vg1_vname,      edi_ql.pos_vg1_dmpa, ...
	             pos_vg2_vname,      edi_ql.pos_vg2_dmpa, ...
	             fv_gd12_vname,      edi_ql.fv_gd12_dmpa, ...
	             fv_gd21_vname,      edi_ql.fv_gd21_dmpa, ...
	             recnum_vname,       edi_ql.recnum, ...
	             recnum_gd12_vname,  edi_ql.recnum_gd12, ...
	             recnum_gd21_vname,  edi_ql.recnum_gd21, ...
	             q_beam_gd12_vname,  edi_ql.quality_gd12, ...
	             q_beam_gd21_vname,  edi_ql.quality_gd21, ...
