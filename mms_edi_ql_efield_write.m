...
%------------------------------------%
	...
	assert( isa(beam.tof_gd12,     'uint32'), 'beam.quality_gd12 should be uint32.');
	assert( isa(beam.tof_gd21,     'uint32'), 'beam.quality_gd21 should be uint32.');
...
%------------------------------------------------------
	...
	vardatatypes = { tt2000_vname,       'cdf_time_tt2000', ...
	                 ...
	                 tof_gd12_vname,     'cdf_uint1',       ...
	                 tof_gd21_vname,     'cdf_uint1',       ...
		...
		'DISPLAY_TYPE',{  ... 
		 ...
		 'FILLVAL',       {  ...
		                    { tt2000_vname,      spdfcomputett2000([9999 12 31 23 59 59 999 999 999]), ...
		                      ...
		                      tof_gd12_vname,    uint32(4294967295), ...
		                      tof_gd21_vname,    uint32(4294967295), ...
		 ...
		 'VALIDMIN',   {  ...
		                  { tt2000_vname,      spdfcomputett2000([2015 3 1 0 0 0 0 0 0]), ...
		                    ...
		                    tof_gd12_vname,    uint32(0),         ...
		                    tof_gd21_vname,    uint32(0),         ...
		 ...
		 'VALIDMAX',   {  ...
		                  { tt2000_vname,      spdfcomputett2000([2050 3 1 0 0 0 0 0 0]), ...
		                    ...
		                    fv_gd12_vname,     single(100000.0),  ...
		                    fv_gd21_vname,     single(100000.0),  ...
		                    tof_gd12_vname,    uint32(1000000),   ...
		                    tof_gd21_vname,    uint32(1000000),   ...
