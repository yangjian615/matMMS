...
%
function cdf_file = mms_fsm_ql_brst_procone(sc, date_start)
...
%------------------------------------%
	...
	for ii = 1 : length(sc)
		...
		try
			% Create the data
			brst_data = mms_fsm_ql_create( sc{ii}, tstart, tend,       ...
			                               'Duration',    duration,    ...
			                               'f_max',       f_max,       ...
			                               'f_min',       f_min,       ...
			                               'fgm_instr',   fgm_instr,   ...
			...
			fsm_data = struct( 'tt2000',      brst_data.tt2000, ...
			                   'tt2000_fgm',  brst_data.tt2000_fgm, ...
			                   'b_fsm_dmpa',  brst_data.b_fsm_dmpa, ...
			                   'b_fgm_dmpa',  brst_data.b_fgm_dmpa, ...
			                   'sc',          sc,         ...
			                   'mode',        'brst',     ...
			                   'instr',       [fgm_instr '-scm'], ...
			                   'tstart',      tstart, ...
			                   'directory',   save_dir, ...
			                   'parents',     { brst_data.parents } ...
			                 );
